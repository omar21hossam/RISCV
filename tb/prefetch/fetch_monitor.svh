    ...
    forever begin
      ...
      @(posedge fetch_intf.clk) begin
        ...
        if (fetch_intf.instr_rvalid_i) begin
          ...
          @(negedge fetch_intf.clk) begin

            seq_item.instr_rdata_id_o = fetch_intf.instr_rdata_id_o;
            seq_item.instr_valid_id_o = fetch_intf.instr_valid_id_o;

            mon_ap.write(seq_item);
            $display("time %0t: data_id_o %0h , valid_id_o %0d ,  instr_addr_o %0d ,  pc_id_o %0d ,  pc_if_o %0d ,  instr_rdata_i %0h",  $time,seq_item.instr_rdata_id_o,seq_item.instr_valid_id_o,
