class fetch_coverage_collector extends uvm_component;
  ...
  covergroup op_instruction_cg;
    ...
    immediate_s_type: coverpoint seq_item_op.instr_rdata_id_o[31:25] {
      bins s_type_1 = {7'h0}; bins s_type_2 = {7'h20};

    }

    immediate_J_type: coverpoint seq_item_op.instr_rdata_id_o[21] {bins j_type_1 = {1'b0};}

    immediate_B_type: coverpoint seq_item_op.instr_rdata_id_o[8] {bins B_type_1 = {1'b0};}
