...
// LSU interface
// ---------------------------------------------------------------------
assign lsu_intf.rst_n                  = `LSU_PATH.rst_n;
...
assign reg_intf.mult_operator_i        = `REGFILE_PATH.mult_operator_i;
assign reg_intf.alu_operator_i         = `REGFILE_PATH.alu_operator_i;
